  ...
  return (
    <>
        <div className={`container-fluid mt-4 p-0 row bg-none d-none d-md-flex ${styles.bodyContainer}`}>
            <div className={`col-12 col-md-4 ${styles.fisrtBox} ${styles.bodyBox} d-flex flex-column p-0 m-0`}>
            ...
            <div className={`col-12 col-md-4 ${styles.middleBox} ${styles.bodyBox} p-0 m-0`}>
            </div>
            <div className={`col-12 col-md-4 d-flex justify-content-center align-items-center ${styles.rightBox} ${styles.bodyBox} d-flex p-0 m-0`}>
        ...
        <div className={`container-fluid mt-3 d-flex d-md-none d-flex flex-column p-0 row bg-none ${styles.bodyContainer}`}>
